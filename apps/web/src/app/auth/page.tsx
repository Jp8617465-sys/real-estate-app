...
type AuthState = 'idle' | 'loading' | 'otp-sent' | 'error';
        ...
        <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              We sent a {authMode === 'magic-link' ? 'magic link' : 'confirmation email'} to{' '}
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-brand-50 to-white">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
        ...
        {authMode === 'password' ? (
          <form className="mt-8 space-y-4" onSubmit={handlePasswordAuth}>
            <div>
            ...
            <button
              ...
              className="w-full rounded-lg bg-brand-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600 disabled:opacity-50"
            >
              {state === 'loading'
                ? 'Signing in...'
                : isLogin
