...
function Illustration({ type, width = 120 }: { type: EmptyStateIllustration; width?: number }) {
  ...
  switch (type) {
    case 'contacts':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          ...
          <path d="M20 95c0-22 18-35 40-35s40 13 40 35" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.3" />
        </svg>
      );
    case 'properties':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          ...
          <path d="M10 60L60 20l50 40" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.3" />
    ...
    case 'alerts':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          <path d="M60 20 L90 75 L30 75 Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" fill="currentColor" opacity="0.1" />
          <line x1="60" y1="45" x2="60" y2="62" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
    ...
    case 'matches':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          <circle cx="45" cy="55" r="25" stroke="currentColor" strokeWidth="3" fill="currentColor" opacity="0.08" />
          <circle cx="75" cy="55" r="25" stroke="currentColor" strokeWidth="3" fill="currentColor" opacity="0.08" />
    ...
    case 'documents':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          <rect x="25" y="15" width="60" height="80" rx="6" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2.5" />
          <line x1="38" y1="40" x2="82" y2="40" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.3" />
          <line x1="38" y1="55" x2="82" y2="55" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.3" />
          <line x1="38" y1="70" x2="62" y2="70" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.3" />
        </svg>
      );
    case 'messages':
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          <rect x="15" y="25" width="90" height="60" rx="10" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2.5" />
          <path d="M35 95 L45 80 L35 95Z" fill="currentColor" opacity="0.15" />
          <line x1="32" y1="50" x2="88" y2="50" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.25" />
          <line x1="32" y1="62" x2="68" y2="62" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.25" />
        </svg>
      );
    default:
      return (
        <svg style={style} viewBox="0 0 120 120" fill="none" aria-hidden="true">
          <circle cx="60" cy="60" r="40" stroke="currentColor" strokeWidth="2.5" fill="currentColor" opacity="0.08" />
          <line x1="60" y1="40" x2="60" y2="65" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      {description && (
        <p className="mt-1.5 max-w-xs text-sm leading-relaxed">{description}</p>
      )}
