  ...
  public: {
    ...
    Views: {
      inbox_thread_summaries: {
        Row: {
          ...
          last_message_channel: Database['public']['Enums']['message_channel'] | null;
    ...
    Enums: {
      ...
      lead_source:
        ...
        | 'other'
        | 'google_ads';
      listing_status: 'pre-market' | 'active' | 'under-offer' | 'sold' | 'withdrawn' | 'leased';
      message_channel:
        | 'email'
        | 'sms'
        | 'phone_call'
      ...
      offer_status: 'pending' | 'countered' | 'accepted' | 'rejected' | 'withdrawn';
      ...
      sale_type: 'private-treaty' | 'auction' | 'expression-of-interest' | 'tender';
      seller_stage:
        | 'appraisal-request'
        | 'listing-preparation'
        | 'on-market'
...
export const Constants = {
  public: {
    Enums: {
      ...
      call_outcome: ['answered', 'missed', 'voicemail', 'no_answer'],
      communication_preference: ['email', 'phone', 'sms', 'any'],
      consolidation_report_status: ['generating', 'ready', 'sent_to_client', 'archived', 'failed'],
      consolidation_report_type: [
        'client_brief_summary',
        'property_comparison',
        'market_analysis',
